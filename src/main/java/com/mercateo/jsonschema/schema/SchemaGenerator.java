...
public class SchemaGenerator {
    ...
    public JsonPropertyResult generateSchema(ObjectContext<?> objectContext,
        ...
        PropertyBuilder propertyBuilder = createPropertyBuilder(context);

        final Property property = propertyBuilder.from(objectContext.getClass());
        return null;
    }

    private PropertyBuilder createPropertyBuilder(SchemaPropertyContext context) {
